...
const liquidbuttonVariants = cva(
  "relative inline-flex items-center justify-center cursor-pointer gap-2 whitespace-nowrap rounded-full font-mono font-semibold transition-all duration-300 disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none select-none",
  {
    variants: {
      ...
      size: {
        default: "min-h-[44px] px-5 py-2.5 text-xs sm:text-sm",
        nav: "h-9 px-4 py-1.5 text-xs sm:text-sm gap-2",
        sm: "min-h-[38px] text-xs gap-2 px-4 py-2",
        lg: "min-h-[50px] rounded-full px-7 py-3 text-xs sm:text-sm font-bold tracking-wider",
        xl: "min-h-[54px] rounded-full px-8 py-3.5 text-sm sm:text-base font-bold tracking-wide",
        xxl: "min-h-[60px] rounded-full px-10 py-4 text-base sm:text-lg font-bold tracking-wide",
